...
def obter_parametros_usuario():
    ...
    tempo = input("Tempo de duração do projeto em meses : ")
    lucro = float(input("Lucro em reais R$: "))
    cnpj = input("CNPJ (se não tiver, colocar Não): ")
    publicoalvo = input("Publico alvo do projeto: ")
    lfreembolso = input("A linha de fomento precisará ser reembolsável? (Sim ou Não): ")
    itensfianciaveis = input("O item pode ser financiado? (Sim ou Não): ")
    ...
    return {
        ...
        "lfreembolso": lfreembolso,
        "itensfianciaveis": itensfianciaveis
    }
